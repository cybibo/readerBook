...
define(function(require, exports, module) {
  ...
  BookFlip.prototype = {
    ...
    _doNext: function() {
      ...
      $prev
        .addClass("animation")
        .one(this.transEndEventName, this._doNextEnd.bind(this, $prev, $active, html, $prevLeft));
      console.timeEnd("prepare animation");
      console.time("paint");
      // do flip animation 
      this._async(function() {
        console.timeEnd("paint");
        $prev.addClass("animation-next");
        $active.addClass("show active");
    ...
    _doNextEnd: function($prev,$active, html, $prevLeft) {
      console.timeEnd("transition");
      console.timeEnd("flip page");
      console.time('render new page');

      $prev.removeClass("animation animation-next active");
    ...
    _doPrev: function() {
      ...
      this._async(function() {
        ...
        $active.addClass("animation-prev");
        console.time("transition");
      }, 50);
    ...
    _doPrevEnd: function($active, html, $activeLeft) {
      ...
      this._reset();
      $active.removeClass("animation animation-next  animation-prev").addClass("active");
    ...
    _doEnd: function(dir) {
      ...
      this._async(function() {
        ...
        $el.addClass("animation " + style)
          .one(this.transEndEventName, function() {
            $el.removeClass(" animation-next-end  animation-prev-end animation");
