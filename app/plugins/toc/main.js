define(function (require, exports, module) {
  ...
  View = PluginBase.View.extend({
    ...
    events: {
      ...
      "click .toc-status-bar .page-jumper .go": "jumpToPage",
      "keyup .toc-status-bar .page-jumper input": "enterPage"
    },
    obEvents: {
    ...
    enterPage: function(evt) {
      if(evt.keyCode == 13){
        this.jumpToPage();
      }
    },
    jumpToPage: function(evt) {
      var pageNumber = parseInt(this.$el.find(".page-jumper input")[0].value), length;
      ...
      this.activePage(pageNumber, 250);
    ...
    activePage: function (page, scrollTimeOut) {
      ...
      this.$el.find(".toc-status-bar .page-number .current-page").html(activePage);
    },
    render: function () {
      var data = {};
      ...
      this.$list = new iScroll(this.$el.find(".iscroll-wrapper")[0], {
        lockDirection: true,
        vScroll: false,
        hScrollbar: false,
        hideScrollbar: true,
